...
plt.savefig('Output/'+model_name+'/figures/'+model_name+'_'+model_file+'_PR.png', dpi=300, format='png')
plt.close()
...
plt.savefig('Output/'+model_name+'/figures/'+model_name+'_'+model_file+'_PRT.png', dpi=300, format='png')
plt.close()
...
plt.savefig('Output/'+model_name+'/figures/'+model_name+'_'+model_file+'_hist.png', dpi=300, format='png')
plt.close()
